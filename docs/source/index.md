...
This is a cloud native distribution. Cloud native is essential for auto-scaling, high availability, and operational automation. For develpment and testing we also support its VM distribution([installation section](https://gluu.org/docs/openbanking/install-cn/#vm-based-distribution) has brief detail on its installation).
