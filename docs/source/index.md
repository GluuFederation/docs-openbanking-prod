...
This is a cloud native distribution. Cloud native is essential for auto-scaling, high availability, and operational automation. For develpment and testing we also support its VM distribution ([installation](https://gluu.org/docs/openbanking/installvm/) Section has detail on how to install it inside VM).
